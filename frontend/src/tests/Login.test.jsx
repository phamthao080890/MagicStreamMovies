...
describe('Login page', () => {
  ...
  test('successful login stores auth and shows success', async () => {
    API.post.mockResolvedValueOnce({
      data: { token: 'tok123', userId: 'u1', name: 'Trump' },
    });
    ...
    fireEvent.change(screen.getByLabelText(/Email/i), { target: { value: 'Trump@example.com' } });
    ...
    expect(localStorage.getItem('name')).toBe('Trump');
    expect(localStorage.getItem('email')).toBe('Trump@example.com');
